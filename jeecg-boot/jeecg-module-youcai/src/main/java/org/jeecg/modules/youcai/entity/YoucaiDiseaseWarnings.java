...
public class YoucaiDiseaseWarnings extends JeecgEntity {
    ...
    @Excel(name = "防控日期", width = 20, format = "yyyy/MM/dd HH:mm:ss") // Excel 导出格式也改一下
    @JsonFormat(timezone = "GMT+8", pattern = "yyyy/MM/dd HH:mm:ss") // Jackson 解析 JSON 的格式
    @DateTimeFormat(pattern = "yyyy/MM/dd HH:mm:ss") // Spring 表单绑定格式
