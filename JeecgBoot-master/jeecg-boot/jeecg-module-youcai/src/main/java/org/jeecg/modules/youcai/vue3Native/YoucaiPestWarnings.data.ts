...
export const superQuerySchema = {
  ...
  pestType: {title: '虫害类型',order: 2,view: 'text', type: 'string',},
  pestName: {title: '虫害名称',order: 3,view: 'text', type: 'string',},
  severity: {title: '严重程度',order: 4,view: 'text', type: 'string',},
  symptoms: {title: '危害症状',order: 5,view: 'textarea', type: 'string',},
  recommendation: {title: '防治建议',order: 6,view: 'textarea', type: 'string',},
  warningStatus: {title: '预警状态',order: 7,view: 'text', type: 'string',},
  imageUrl: {title: '虫害影像',order: 8,view: 'text', type: 'string',},
};
