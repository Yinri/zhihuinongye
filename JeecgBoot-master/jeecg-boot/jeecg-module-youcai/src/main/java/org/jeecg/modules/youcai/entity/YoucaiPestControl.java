...
public class YoucaiPestControl implements Serializable {
    private static final long serialVersionUID = 1L;

	/**防控ID*/
	@TableId(type = IdType.ASSIGN_ID)
    @Schema(description = "防控ID")
    ...
    private java.lang.Integer warningId;
	/**虫害类型*/
    ...
    private java.math.BigDecimal pesticideDosage;
	/**农药浓度(%)*/
	@Excel(name = "农药浓度(%)", width = 15)
    @Schema(description = "农药浓度(%)")
    private java.math.BigDecimal pesticideConcentration;
	/**施用方法*/
    ...
    private java.math.BigDecimal controlArea;
	/**防控成本(元)*/
	@Excel(name = "防控成本(元)", width = 15)
    @Schema(description = "防控成本(元)")
    private java.math.BigDecimal controlCost;
	/**防控效果*/
	@Excel(name = "防控效果", width = 15)
    @Schema(description = "防控效果")
    private java.lang.String controlEffectiveness;
	/**操作员*/
