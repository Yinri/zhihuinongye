...
export const columns: BasicColumn[] = [
  ...
  },
  {
    ...
    customRender: ({ record }) => {
      ...
      const text = type === '0' ? '蕾薹期初期管理' : type === '1' ? '蕾薹期中期管理' : type === '2' ? '蕾薹期后期管理' : '病虫害防治';
...
export const searchFormSchema: FormSchema[] = [
  ...
  },
  {
    ...
    componentProps: {
      options: [
        { label: '蕾薹期初期管理', value: '0' },
        { label: '蕾薹期中期管理', value: '1' },
        { label: '蕾薹期后期管理', value: '2' },
        { label: '病虫害防治', value: '3' },
      ],
    },
    colProps: { span: 8 },
