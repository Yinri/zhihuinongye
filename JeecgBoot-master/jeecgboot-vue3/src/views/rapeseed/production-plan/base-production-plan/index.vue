...
import { Icon } from '/src/components/Icon';
  import SelectVariety from "@/views/rapeseed/production-plan/base-production-plan/components/SelectVariety.vue";
  import ProductionAdjust from "@/views/rapeseed/production-plan/base-production-plan/components/ProductionAdjust.vue";
  import PredictionResults from "@/views/rapeseed/production-plan/base-production-plan/components/PredictionResults.vue";
  import DataBasis from "@/views/rapeseed/production-plan/base-production-plan/components/DataBasis.vue";
  import BaseOverview from "@/views/rapeseed/production-plan/base-production-plan/components/BaseOverview.vue";
  import ProgressTrack from "@/views/rapeseed/production-plan/base-production-plan/components/ProgressTrack.vue";
  import ShowAllVariety from "@/views/rapeseed/production-plan/base-production-plan/components/ShowAllVariety.vue";
  import QueryPlan from "@/views/rapeseed/production-plan/base-production-plan/components/QueryPlan.vue";
